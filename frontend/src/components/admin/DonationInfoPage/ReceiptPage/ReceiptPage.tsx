...
const exportPdf = (id: string) => {
  html2canvas(document.querySelector(id)!).then((canvas) => {
    ...
    const pdf = new JsPDF();
    pdf.addImage(imgData, "PNG", 1, 1, 0, 0);
    ...
    <div>
      <div id="receipt">
        ...
        <div className="form-body">
          ...
          <h2>
            Habitat for Humanity for San Luis Obispo County thanks you for your
            donation. Your generosity is appreciated!
          </h2>
          <h2>
            Habitat for Humanity for San Luis Obispo County builds and renovates
            homes to improve communities by partnering with families in need.
            Your gift will go to build homes or provide funds to build houses
            for families in our count.
          </h2>
