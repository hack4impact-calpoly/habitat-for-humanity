...
const avaiTimes = [
    { day: "Tuesday, January 11",   hours: ["10:00 AM to 11:00AM", "11:00 AM to 12:00 PM", "12:00 PM to 1:00 PM"]},
...
const DonationInfoPage = (): JSX.Element => {
        ...
        <>
            <div id="DonInfoPage">
                ...
                <div id="DonInfoBox">
                    ...
                    <Tabs value={value} onChange={handleChange} variant="fullWidth" TabIndicatorProps={{style: {background:'#314d89'}}} textColor='primary'>
                        <Tab label={<span className="IndividTabs">Donation Info</span> }{...a11yProps(0)} />
                        <Tab label={<span className="IndividTabs">Scheduling</span> }{...a11yProps(1)} />
                        <Tab label={<span className="IndividTabs">Receipt</span> }{...a11yProps(2)} />
                    </Tabs>
                    </Box>
                    </div>
                ...
                <div id="DonInfoButtons">
                        ...
                        <div id="NextButtons">
                        <button className="rejectButton">Reject Donation</button>
                        <button className="approveButton">Approve and Schedule</button>
                        </div>
                </div>
            </div>
        </>
