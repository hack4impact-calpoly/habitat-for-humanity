...
import DonatorSchedulePickUp from "components/donor/DonorScheduleDropoffPickupPage/DonorSchedulePickUp";
  ...
  return (
    <div style={{ paddingBottom: "4rem" }}>
      ...
      <div id="donDropoffPage">
        ...
        <div>
          ...
          <div id="donPDOptions">
            <div>
              <input
                type="radio"
                className="radioOptionLabel"
                onChange={() => flipDropoff()}
                checked={isDropoff}
              />
        ...
        {isDropoff ? <DonatorScheduleDropoff /> : <DonatorSchedulePickUp />}
      </div>
    </div>
  );
}
